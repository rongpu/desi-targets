...
def get_sweep_columns(sweep_fn, field):
    ...
    if field=='north':
        ...
        pz_fn = os.path.join(pz_dir, 'south_zp_corrected', pz_fn)
...
pz_dir = '/global/cfs/cdirs/desicollab/users/rongpu/data/ls_dr9.0_desi_photoz/pz'

pz_columns = ['Z_PHOT_MEAN', 'Z_PHOT_MEDIAN', 'Z_PHOT_STD', 'Z_PHOT_L68', 'Z_PHOT_U68', 'Z_PHOT_L95', 'Z_PHOT_U95', 'Z_SPEC', 'SURVEY', 'TRAINING']

cat_basic_path = '/global/cfs/cdirs/desicollab/users/rongpu/targets/dr9.0/zp_offset_corrected/dr9_extended_lrg_basic.fits'
cat_pz_path = '/global/cfs/cdirs/desicollab/users/rongpu/targets/dr9.0/zp_offset_corrected/dr9_extended_lrg_pz_new.fits'

# cat_basic_path = '/global/cfs/cdirs/desicollab/users/rongpu/targets/dr9.0/zp_offset_corrected/dr9_lrg_basic.fits'
# cat_pz_path = '/global/cfs/cdirs/desicollab/users/rongpu/targets/dr9.0/zp_offset_corrected/dr9_lrg_pz_new.fits'
