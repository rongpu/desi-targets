# srun -N 1 -C haswell -c 64 -t 04:00:00 -q interactive python create_main_lrg_catalog_for_magnification.py north
...
cat.write('/global/cfs/cdirs/desi/users/rongpu/data/lrg_xcorr/magnification/main_lrg_magnification_{}.fits'.format(field), overwrite=True)
