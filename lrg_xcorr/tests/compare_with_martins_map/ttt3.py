...
for bin_index in range(1, 5):
    ...
    for nside in [64]:
        ...
        plot_path = os.path.join(plot_dir, 'density_lrg_pz_bin_{}_{}-ratio-seismic.png'.format(bin_index, nside))
        ...
        maps = join(maps, hp_table, keys='HPXPIXEL')
        ...
        plot_map(nside, maps['density']/(maps['delta']+1), pix=maps['HPXPIXEL'], cmap='seismic',
                 vmin=0.9, vmax=1.1, xsize=xsize_dict[nside], dpi=dpi_dict[nside],
