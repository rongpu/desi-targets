...
columns_to_keep = ['RA', 'DEC', 'NOBS_G', 'NOBS_R', 'NOBS_Z', 'MASKBITS', 'PHOTSYS', 'Z_PHOT_MEDIAN', 'pz_bin']
...
for field in ['north', 'south']:
    ...
    if field=='south':
        pz_cuts = [0.350, 0.540, 0.703, 0.840, 0.950]
    else:
        pz_cuts = [0.350, 0.549, 0.710, 0.837, 0.944]
...
output_path = '/global/cscratch1/sd/rongpu/temp/main_lrg_minobs_{}_maskbits_{}_20210716.fits'.format(min_nobs, ''.join([str(tmp) for tmp in maskbits]))
print(output_path)
