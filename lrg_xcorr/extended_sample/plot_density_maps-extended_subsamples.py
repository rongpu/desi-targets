...
top_plot_dir = '/global/cfs/cdirs/desi/users/rongpu/lrg_xcorr/imaging_sys/density_maps/extended_lrg'
...
# dpi_dict = {64: 100, 128: 100, 256: 200, 512: 200}
# xsize_dict = {64: 2000, 128: 2000, 256: 4000, 512: 4000}
# vrange_dict = {64: 12, 128: 14, 256: 21}
vcenter_dict = {1: 185.4, 2: 312.2, 3: 417.2, 4: 433.7}  # average density in DECam imaging

vrange_dict_main_lrg = {64: 8, 128: 12, 256: 18}
vcenter_dict_main_lrg = {1: 81.0, 2: 147.5, 3: 164.2, 4: 149.4}  # average density in DECam imaging
...
for bin_index in range(1, 5):
    ...
    for nside in [64, 128, 256]:
        ...
        plot_dir = os.path.join(top_plot_dir, 'extended_lrg_pz_{}_minobs_{}_maskbits_{}'.format(field, min_nobs, mask_str))
        if not os.path.isdir(plot_dir):
            os.makedirs(plot_dir)

        plot_path = os.path.join(plot_dir, 'density_extended_lrg_pz_bin_{}_{}.png'.format(bin_index, nside))
        if weighted:
        ...
        for field in ['north', 'south']:
            ...
            density = Table(fitsio.read(os.path.join(target_densities_dir, 'density_map_extended_lrg_pz_bin_{}_{}_nside_{}_minobs_{}{}.fits'.format(bin_index, field, nside, min_nobs, weighted_str))))
        ...
        # Peg the vrange to the fractional vragen of main_lrg
        vcenter_main_lrg = vcenter_dict_main_lrg[bin_index]
        vrange_main_lrg = int(np.sqrt(vcenter_main_lrg)*vrange_dict_main_lrg[nside])
        vcenter = vcenter_dict[bin_index]
        vrange = vrange_main_lrg/vcenter_main_lrg * vcenter
        ...
        plot_map(nside, maps['HPXPIXEL'], maps['density'],
                 ...
                 title='Extended LRG photo-z bin {} NSIDE={}'.format(bin_index, nside), save_path=plot_path, show=False)
