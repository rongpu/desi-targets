...
if include_ebv:
    weights_path = '/global/cfs/cdirs/desi/users/rongpu/data/lrg_xcorr/catalogs/more/dr9_extended_lrg_pzbins_20230509-weights.fits'
else:
    weights_path = '/global/cfs/cdirs/desi/users/rongpu/data/lrg_xcorr/catalogs/more/dr9_extended_lrg_pzbins_20230509-weights_no_ebv.fits'
