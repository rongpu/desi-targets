...
if include_ebv:
    weights_path = '/global/cfs/cdirs/desi/users/rongpu/data/lrg_xcorr/catalogs/more/dr9_extended_lrg_pzbins_20230509-weights-separate_des_and_decals.fits'
else:
    weights_path = '/global/cfs/cdirs/desi/users/rongpu/data/lrg_xcorr/catalogs/more/dr9_extended_lrg_pzbins_20230509-weights_no_ebv-separate_des_and_decals.fits'
...
if __name__ == '__main__':
    ...
    for field in ['north', 'south']:
        ...
        for bin_index in range(1, 5):  # 4 bins
            ...
            for nside in nsides:
                if include_ebv:
                    output_path = os.path.join(output_dir, 'density_map_extended_lrg_pz_bin_{}_{}_nside_{}_minobs_{}-lw-separate_des_weights.fits'.format(bin_index, field, nside, min_nobs))
                else:
                    output_path = os.path.join(output_dir, 'density_map_extended_lrg_pz_bin_{}_{}_nside_{}_minobs_{}-lw_no_ebv-separate_des_weights.fits'.format(bin_index, field, nside, min_nobs))
