...
output_dir = '/global/cfs/cdirs/desi/users/rongpu/data/lrg_xcorr/catalogs/more'
...
cat_basic_path = os.path.join(output_dir, 'dr9_extended_lrg_0.49.0_basic.fits')
cat_sweep_1_path = os.path.join(output_dir, 'dr9_extended_lrg_0.49.0_sweep_1.fits')
cat_sweep_2_path = os.path.join(output_dir, 'dr9_extended_lrg_0.49.0_sweep_2.fits')
cat_sweep_extra_path = os.path.join(output_dir, 'dr9_extended_lrg_0.49.0_sweep_extra_1.fits')
cat_pz_path = os.path.join(output_dir, 'dr9_extended_lrg_0.49.0_pz_dr9.fits')
