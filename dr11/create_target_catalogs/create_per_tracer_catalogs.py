...
# target_class: "LRG", "ELG", "QSO", "LGE" or "BGS_ANY"
target_class = str(sys.argv[1])
target_class = target_class.upper()

target_bits = {'LRG': 0, 'ELG': 1, 'QSO': 2, 'LGE': 3, 'BGS_ANY': 60}
...
cat_basic_path = os.path.join(output_dir, 'dr11_{}_5.1.0_basic.fits'.format(target_class.lower()))
cat_photom_path = os.path.join(output_dir, 'dr11_{}_5.1.0_photom.fits'.format(target_class.lower()))
