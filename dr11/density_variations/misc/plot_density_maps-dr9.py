...
target_counts_dir = '/global/cfs/cdirs/desi/users/rongpu/data/imaging_sys/dr11/density_maps/dr9_for_comparison'
...
for target_class in ['BGS_ANY', 'LRG', 'LGE', 'ELG', 'QSO']:

    print(target_class)

    if target_class=='LGE':
        target_ver_str = '3.0.0'
    else:
