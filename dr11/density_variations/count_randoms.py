# srun -N 1 -C cpu -t 04:00:00 -q interactive python count_randoms.py south
...
if resolve=='resolve':
    randoms_paths = sorted(glob.glob('/global/cfs/cdirs/desi/target/catalogs/dr11/5.1.0/randoms/resolve/randoms-[0-9]*.fits'))
elif resolve=='noresolve':
    randoms_paths = sorted(glob.glob('/global/cfs/cdirs/desi/target/catalogs/dr11/5.1.0/randoms/noresolve/{}/randoms-noresolve-*.fits'.format(field)))
...
output_dir = '/global/cfs/cdirs/desi/users/rongpu/data/imaging_sys/dr11/randoms_stats/5.1.0/{}/counts'.format(resolve)
