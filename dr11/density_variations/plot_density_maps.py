...
target_ver_str = '5.1.0'

min_nobs = 1
maskbits_dict = {'LRG': [1, 8, 9, 11, 12, 13], 'LGE': [1, 8, 9, 11, 12, 13], 'ELG': [1, 11, 12, 13], 'QSO': [1, 8, 9, 11, 12, 13], 'BGS_ANY': [1, 13], 'BGS_BRIGHT': [1, 13]}
custom_mask_dict = {'LRG': '', 'LGE': '', 'ELG': '', 'QSO': '', 'BGS_ANY': '', 'BGS_BRIGHT': ''}

# maskbits_dict = {'LRG': [], 'ELG': [], 'ELG_LOP': [], 'QSO': [1, 8, 9, 11, 12, 13], 'BGS_ANY': [1, 13], 'BGS_BRIGHT': [1, 13]}
# custom_mask_dict = {'LRG': 'lrgmask_v1.1', 'LGE': 'lrgmask_v1.1', 'ELG': 'elgmask_v1', 'ELG_LOP': 'elgmask_v1', 'QSO': '', 'BGS_ANY': '', 'BGS_BRIGHT': ''}

randoms_counts_dir = '/global/cfs/cdirs/desi/users/rongpu/data/imaging_sys/dr11/randoms_stats/5.1.0/resolve/counts'
# randoms_systematics_dir = '/global/cfs/cdirs/desi/users/rongpu/data/imaging_sys/dr11/randoms_stats/5.1.0/resolve/systematics'
target_counts_dir = '/global/cfs/cdirs/desi/users/rongpu/data/imaging_sys/dr11/density_maps/{}/resolve'.format(target_ver_str)

top_plot_dir = '/global/cfs/cdirs/desi/users/rongpu/imaging_sys/dr11/density_maps/{}/resolve'.format(target_ver_str)
...
vrange_dict = {'BGS_ANY': {64: [800, 2000], 128: [650, 2150], 256: [200, 2600], 512: [-200, 3000]},
               ...
               'LGE': {64: [150, 450], 128: [100, 500], 256: [50, 550], 512: [-100, 700]},
...
for target_class in ['BGS_ANY', 'BGS_BRIGHT', 'LRG', 'LGE', 'ELG', 'ELG_LOP', 'QSO']:
    ...
    for nside in [64, 128, 256, 512]:
        ...
        density = Table.read(os.path.join(target_counts_dir, 'counts_{}_{}_nside_{}_minobs_{}_maskbits_{}.fits'.format(target_class, field, nside, min_nobs, mask_str)))
        ...
        plot_map(nside, maps['density'], pix=maps['HPXPIXEL'],
                 ...
                 title='DR11 {} NSIDE={}'.format(target_class.upper(), nside), save_path=plot_path, show=False)
