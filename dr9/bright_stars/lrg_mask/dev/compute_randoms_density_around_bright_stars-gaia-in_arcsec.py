...
gaia_min_list = [15.5, 16.0, 16.5, 17.0, 17.5]
gaia_max_list = [16.0, 16.5, 17.0, 17.5, 18.0]
search_radius_list = [25, 25, 25, 25, 25]
...
save_path = '/global/u2/r/rongpu/notebooks/desi_mask/data/new_mask/density_rand_gaia_{}_minobs_{}_maskbits_{}_wise_v3-arcsec.npy'.format(field, min_nobs, ''.join([str(tmp) for tmp in maskbits]))
