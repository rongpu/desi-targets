...
save_path = '/global/u2/r/rongpu/notebooks/desi_mask/data/new_mask/density_rand_gaia_decam_{}_{}_minobs_{}_maskbits_{}.npy'.format(decam_band, field, min_nobs, ''.join([str(tmp) for tmp in maskbits]))
