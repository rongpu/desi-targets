...
save_path = '/global/u2/r/rongpu/notebooks/desi_mask/data/lrgmask_v1/density_rand_wise_{}_minobs_{}_lrgmask_{}-in_mask_radii.npy'.format(field, min_nobs, ''.join([str(tmp) for tmp in lrgmask_bits]))
