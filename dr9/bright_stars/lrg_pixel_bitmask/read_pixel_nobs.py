...
# Examples:
# srun -N 1 -C haswell -c 64 -t 04:00:00 -q interactive python read_pixel_nobs.py --input catalog.fits --output catalog_nobs.fits
# srun -N 1 -C haswell -c 64 -t 04:00:00 -q interactive python read_pixel_nobs.py --input /global/cfs/cdirs/desi/target/catalogs/dr9/0.49.0/randoms/resolve/randoms-1-0.fits --output $CSCRATCH/temp/randoms-1-0-nobs.fits
# srun -N 1 -C haswell -c 64 -t 04:00:00 -q interactive python read_pixel_nobs.py --input /global/cfs/cdirs/desi/users/rongpu/targets/dr9.0/1.0.0/resolve/dr9_lrg_south_1.0.0_basic.fits --output $CSCRATCH/temp/dr9_lrg_south_1.0.0_nobs.fits
