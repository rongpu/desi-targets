...
# Example:
# srun -N 1 -C haswell -c 64 -t 04:00:00 -L cfs -q interactive python add_sweep_columns_to_target_catalogs.py sv1 LRG south
...
output_path = os.path.join(data_dir, 'dr9_{}_{}_{}_0.49.0_more_1.fits'.format(program, target_class.lower(), field))
