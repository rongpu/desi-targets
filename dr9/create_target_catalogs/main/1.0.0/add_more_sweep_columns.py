...
# Example:
# srun -N 1 -C haswell -c 64 -t 04:00:00 -L cfs -q interactive python add_more_sweep_columns.py LRG south
...
sweep_columns = ['GALDEPTH_G', 'GALDEPTH_R', 'GALDEPTH_Z',
...
output_path = os.path.join(data_dir, 'dr9_{}_{}_1.0.0_more_2.fits'.format(target_class.lower(), field))
