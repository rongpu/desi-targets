# Add photo-z columns for the BGS sample
...
pz_dir = '/dvs_ro/cfs/cdirs/desicollab/users/rongpu/data/ls_dr9.0_desi_photoz/pz_public'
...
cat_pz_path = '/global/cfs/cdirs/desicollab/users/rongpu/targets/dr9.0/zp_offset_corrected/dr9_bgs_pz.fits'
