...
cat_basic_path = os.path.join(output_dir, 'dr9_extended_lrg_basic.fits')
cat_photom_path = os.path.join(output_dir, 'dr9_extended_lrg_photom.fits')
cat_more_1_path = os.path.join(output_dir, 'dr9_extended_lrg_more_1.fits')
cat_more_2_path = os.path.join(output_dir, 'dr9_extended_lrg_more_2.fits')
