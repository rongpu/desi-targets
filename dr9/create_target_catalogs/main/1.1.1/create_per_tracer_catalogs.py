...
target_dir = '/global/cfs/cdirs/desi/target/catalogs/dr9/1.1.1/targets/main/resolve'
...
cat_photom_path = os.path.join(output_dir, 'dr9_{}_1.1.1_photom.fits'.format(target_class.lower()))
