# Add sweep columns
# Example:
# python add_sweep_columns_to_target_catalogs_2.py sv1 LRG south
...
ls_columns = ['FRACFLUX_G', 'FRACFLUX_R', 'FRACFLUX_Z', 'FRACFLUX_W1', 'FRACFLUX_W2', 'FRACMASKED_G', 'FRACMASKED_R', 'FRACMASKED_Z', 'FRACIN_G', 'FRACIN_R', 'FRACIN_Z']
...
more_path = os.path.join(data_dir, 'dr9_{}_{}_{}_0.49.0_more_2.fits'.format(program, target_class.lower(), field))
