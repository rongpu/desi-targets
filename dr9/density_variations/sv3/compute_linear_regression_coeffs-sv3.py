    ...
    for target_class in ['BGS_ANY', 'BGS_BRIGHT', 'ELG', 'QSO', 'LRG']:
        ...
        if separate_des:
            ...
            for region in ['BASS+MzLS', 'DECaLS', 'DES']:
                ...
                with open(os.path.join(output_dir, 'sv3_{}'.format(weights_ver), 'sv3_{}_linear_coeffs_separate_des_{}.yaml'.format(target_class, weights_ver)), 'w') as f:
            ...
            with open(os.path.join(output_dir, 'sv3_{}'.format(weights_ver), 'sv3_{}_linear_coeffs_{}.yaml'.format(target_class, weights_ver)), 'w') as f:
                yaml.dump(coeff_dict, f)
