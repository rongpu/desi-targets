...
output_dir = '/Users/rongpu/Documents/Data/desi_targets/dr9.0/imaging_sys/linear_weights'
...
for separate_des in [True, False]:
    ...
    for target_class in ['BGS_ANY', 'BGS_BRIGHT', 'ELG', 'QSO', 'LRG']:
        ...
        if separate_des:
            ...
            for region in ['BASS+MzLS', 'DECaLS', 'DES']:
                ...
                with open(os.path.join(output_dir, 'main_{}'.format(weights_ver), 'main_{}_linear_coeffs_separate_des_{}.yaml'.format(target_class, weights_ver)), 'w') as f:
            ...
            with open(os.path.join(output_dir, 'main_{}'.format(weights_ver), 'main_{}_linear_coeffs_{}.yaml'.format(target_class, weights_ver)), 'w') as f:
                yaml.dump(coeff_dict, f)
