...
output_dir = '/Users/rongpu/Documents/Data/desi_targets/dr9.0/imaging_systematics/linear_weights/main_v0.1'
...
for target_class in ['BGS_ANY', 'BGS_BRIGHT', 'LRG', 'ELG', 'QSO']:
    ...
    with open(os.path.join(output_dir, "main_{}_linear_coeffs_v0.1.yaml".format(target_class)), "w") as f:
