python compute_density_variations.py BGS_ANY north
python compute_density_variations.py BGS_ANY south
python compute_density_variations.py BGS_BRIGHT north
python compute_density_variations.py BGS_BRIGHT south
python compute_density_variations.py LRG north
