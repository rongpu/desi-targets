...
top_plot_dir = '/Users/rongpu/Documents/Work/DESI/imaging_systematics/density_maps/resolve'

target_class = 'LRG'
target_class = target_class.lower()

dpi_dict = {64: 200, 128: 200, 256: 600}
vrange_dict = {'BGS_ANY':{64: [800, 2000], 128: [650, 2150], 256: [400, 2400]},
               'BGS_BRIGHT':{64: [500, 1200], 128: [350, 1350], 256: [200, 1500]},
               'LRG':{64: [300, 900], 128: [200, 1000], 256: [100, 1100]},
               'ELG':{64: [1200, 3600], 128: [1200, 3600], 256: [1200, 3600]},
               'QSO':{64: [150, 450], 128: [150, 450], 256: [100, 500]},
               }
...
# for target_class in ['BGS_ANY', 'BGS_BRIGHT', 'QSO']:
    ...
    for nside in [64, 128, 256]:
        ...
        maps = join(maps, density[['hp_idx', 'target_count']], join_type='outer', keys='hp_idx').filled(0)
        ...
        hp.mollview(mplot, min=vrange_dict[target_class.upper()][nside][0], max=vrange_dict[target_class.upper()][nside][1],
                    rot=(120, 0, 0), fig=1, xsize=8000, title='{} NSIDE={}'.format(target_class.upper(), nside))
