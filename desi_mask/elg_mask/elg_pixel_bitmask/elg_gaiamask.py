# Create pixel-level per-brick ELG GAIA mask
...
# salloc -N 3 -C haswell -q interactive -t 04:00:00 --account desi
...
gaia_path = '/global/cfs/cdirs/desi/users/rongpu/desi_mask/gaia_elg_mask_v1.fits'

output_dir = '/global/cscratch1/sd/rongpu/desi/veto_masks/elg/dev/gaiamask/v1'
...
print('elg_gaiamask {} {} {} Done!'.format(field, n_task, task_id), time.strftime("%H:%M:%S", time.gmtime(time.time() - time_start)))
