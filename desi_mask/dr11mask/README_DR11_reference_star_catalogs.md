...
This document describes the DR11-oriented replacement for the DR9
reference-star catalog scripts in `desi_mask/reference/`, `desi_mask/lrg_mask/`,
and `desi_mask/elg_mask/`.

For per-brick pixel-mask generation after these catalogs exist, see
`README_DR11_pixel_masks.md`.
