...
if done:
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/everest/sv3_done_{}_lrg.fits'.format(coadd_type), overwrite=False)
else:
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/everest/sv3_{}_lrg.fits'.format(coadd_type), overwrite=False)
