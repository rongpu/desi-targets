...
data_dir = '/global/cfs/cdirs/desi/spectro/redux/f3/tiles/{}'.format(coadd_type)
...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/f3/sv1_{}_lrg.fits'.format(coadd_type), overwrite=False)
...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/f3/sv3_{}_lrg.fits'.format(coadd_type), overwrite=False)
...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/f3/main_{}_lrg.fits'.format(coadd_type), overwrite=False)
