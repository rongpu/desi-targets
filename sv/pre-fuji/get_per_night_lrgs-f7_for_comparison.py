...
# Also create the f3 and Everest catalog for the same tile/night
...
data_dir = '/global/cfs/cdirs/desi/users/sjbailey/spectro/redux/f7/tiles/{}'.format(coadd_type)
...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/f7/sv1_{}_lrg.fits'.format(coadd_type), overwrite=False)
...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/f7/sv3_{}_lrg.fits'.format(coadd_type), overwrite=False)
...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/f7/main_{}_lrg.fits'.format(coadd_type), overwrite=False)
