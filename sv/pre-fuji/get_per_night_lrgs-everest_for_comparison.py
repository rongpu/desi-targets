...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/everest_for_comparison/sv1_{}_lrg.fits'.format(coadd_type), overwrite=False)
...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/everest_for_comparison/sv3_{}_lrg.fits'.format(coadd_type), overwrite=False)
...
if len(cat_stack)>0:
    ...
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/pre-fuji/everest_for_comparison/main_{}_lrg.fits'.format(coadd_type), overwrite=False)
