...
if done:
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/daily/main_done_{}_lrg_20211012.fits'.format(coadd_type), overwrite=True)
else:
    cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/daily/main_{}_lrg_20211012.fits'.format(coadd_type), overwrite=True)
