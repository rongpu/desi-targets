...
for tileid in tileid_list:
    ...
    sanity = glob.glob(os.path.join(data_dir, str(tileid), '*'))
    if len(sanity)>1:
        raise ValueError()
...
output_path = '/global/cfs/cdirs/desi/users/rongpu/spectro/daily/main_done_{}_lrg_good_20210917_to_2021130.fits'.format(coadd_type)
print(output_path)
