...
mask = tiles['LASTNIGHT']<20210801  # pre shutdown
tiles = tiles[mask]
print(len(tiles))
...
output_path = '/global/cfs/cdirs/desi/users/rongpu/spectro/daily/main_done_{}_lrg_good_preshutdown.fits'.format(coadd_type)
print(output_path)
