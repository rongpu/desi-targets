...
mask &= tiles['LASTNIGHT']<=20211009  # dates of reprocessing
tiles = tiles[mask]
print(len(tiles))
...
output_path = '/global/cfs/cdirs/desi/users/rongpu/spectro/daily/main_done_{}_lrg_good_20210917_to_20211009.fits'.format(coadd_type)
print(output_path)
