# Denali
# Select LRG+QSO tiles; add sweep columns and photo-z's
...
zbest.write('/global/cfs/cdirs/desi/users/rongpu/spectro/sv1/testdenali_alltiles_Allzinfo_LRG_pz_added.fits', overwrite=True)
