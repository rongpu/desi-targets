# Create combined main cumulative BGS catalog
...
cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/fugu/main_{}_bgs.fits'.format(coadd_type), overwrite=True)
