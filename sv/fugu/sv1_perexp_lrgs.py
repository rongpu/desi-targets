...
columns_2 = ['TARGETID', 'PETAL_LOC', 'DEVICE_LOC', 'LOCATION', 'FIBER', 'TARGET_RA', 'TARGET_DEC', 'MORPHTYPE', 'FLUX_G', 'FLUX_R', 'FLUX_Z', 'PARALLAX', 'EBV', 'FLUX_W1', 'FLUX_W2', 'FIBERFLUX_G', 'FIBERFLUX_R', 'FIBERFLUX_Z', 'MASKBITS', 'PHOTSYS', 'SV1_DESI_TARGET', 'SV1_BGS_TARGET', 'DESI_TARGET', 'BGS_TARGET', 'TILEID']
columns_3 = ['TARGETID', 'EXPID', 'EXPTIME', 'FIBERSTATUS', 'DELTA_X', 'DELTA_Y', 'NIGHT']
...
data_dir = '/global/cfs/cdirs/desi/spectro/redux/fuji/tiles/perexp'
...
exposures = Table(fitsio.read('/global/cfs/cdirs/desi/spectro/redux/fuji/exposures-fuji.fits', ext=1))
...
cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/fugu/sv1_perexp_lrg.fits', overwrite=True)
