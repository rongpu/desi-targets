...
def get_sample(sweep_fn):
    ...
    cat = cat[mask]
    cat = cat[['TARGETID', 'RA', 'DEC', 'elg_original', 'elg_gmag', 'elg_brighter', 'elg_gmag_brighter']]
...
cat_stack.write('/pscratch/sd/r/rongpu/ebv/alternative_elg_targets/alternative_elg_targets.fits', overwrite=True)
