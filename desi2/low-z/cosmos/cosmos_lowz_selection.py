# Create target catalog for the COSMOS low-z secondary program
# The final version (v0.6)
...
# parent_path = '/global/cfs/cdirs/desi/users/rongpu/misc/cosmos_lowz_20220404/cosmos_lowz_sample_v0.6.fits'
parent_path = '/global/cfs/cdirs/desi/users/rongpu/data/desi2/cosmos_lowz/targets/cosmos_lowz_targets.fits'
prognum = 1
# fa_path = '/global/cfs/cdirs/desi/users/rongpu/misc/cosmos_lowz_20220404/tertiary-targets-{}.fits'.format(str(prognum).zfill(4))
fa_path = '/global/cfs/cdirs/desi/users/rongpu/data/desi2/cosmos_lowz/targets/tertiary-targets-{}.fits'.format(str(prognum).zfill(4))

# COSMOS field center
ra, dec = 150.100, 2.182
