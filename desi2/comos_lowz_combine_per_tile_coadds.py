...
cat.remove_columns(['EBV', 'FIBERFLUX_Z', 'FLUX_G', 'FLUX_R', 'FLUX_W1', 'FLUX_W2', 'FLUX_Z', 'MASKBITS'])
cat = join(cat, parent, keys='TARGETID_TERTIARY', join_type='left').filled(0)

cat.write('/global/cfs/cdirs/desi/users/rongpu/spectro/cosmos_lowz/daily/cosmosz_lowz_per_tile_coadds.fits')
