...
primary &= (cat['TYPE']!='PSF') | (cat['zmag'] - cat['w1mag'] > 0.8 * (cat['rmag'] - cat['zmag']) - 1.1)  # stellar rejection
...
cat.write('/global/cfs/cdirs/desi/users/rongpu/misc/cosmos_lowz_sample_v0.5.fits')
